...
import logoImg from '../../assets/CineBusca_negro.svg';
import logoDark from '../../assets/CineBusca_blanco.svg'
    ...
    <nav className="sticky top-0 z-50 backdrop-blur-lg border-b transition-colors duration-300
      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          <img src={theme === 'dark' ? logoDark : logoImg} alt="CineBusca" className="h-10 w-auto object-contain"/>
        </Link>
